<template>
    <div class="w-14 sm:w-32 md:w-52 lg:w-60 fixed top-0 z-40 h-screen bg-white shadow-md select-none dark:bg-dark_secondary dark:text-gray-100 dark:border-gray-600">
        <div class="mt-3 flex justify-center">
            <router-link to="/admin" class="px-1 sm:px-10 py-1 flex items-end transition rounded-md cursor-pointer bg-gradient-to-r hover:from-secondary hover:to-primary hover:text-gray-100" @click="clearMenu">
