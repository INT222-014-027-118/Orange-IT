            ...
            if (this.searchText.length > 0) {
                return this.$store.getters.users.filter((user) => {
                    return (
                        ...
                        // user.userFirstName.toLowerCase().includes(this.searchText.toLowerCase()) ||
                        // user.userLastName.toLowerCase().includes(this.searchText.toLowerCase()) ||
                        this.searchText == user.id
                    );
                });
            }
