    ...
    <div class="mx-auto max-w-7xl sm:mt-5">
        <div class="relative grid grid-cols-3 gap-3 px-1 md:mt-0 md:p-2 lg:mx-auto">
            <div class="flex-col col-span-3 md:col-span-2 felx">
                <h1 class="py-3 px-3 text-2lg md:text-3xl font-semibold flex items-center"><span class="material-icons mr-2 text-xl py-2 px-3 bg-primary text-white rounded-full"> shopping_cart </span>Cart</h1>
            ...
            <div class="col-span-3 pb-28 sm:pb-10 md:pb-0 md:col-span-1 ">
                <h1 class="py-4 text-lg md:text-3xl font-semibold hidden md:block">Order summary</h1>
